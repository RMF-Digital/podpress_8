...
class podPressAdmin_class extends podPress_class
	{
		...
		function settings_feed_edit() {
			...
			$generalsettingspodpressurl = trailingslashit($adminurl).'admin.php?page=podpress_general';
		...
		function settings_feed_save() {
			...
			if ( FALSE !== $result ) {
				$location = site_url() . '/wp-admin/admin.php?page=podpress_feed&updated=true'.'&debugreport='.$report;
			} else {
				$location = site_url() . '/wp-admin/admin.php?page=podpress_feed&updated=false'.'&debugreport='.$report;
			}
